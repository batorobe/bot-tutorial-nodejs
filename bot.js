...
function respond() {
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    postMessage("http://daddyleagues.com/r3dzone/team/"+request.text.substring(5,8)+"/depthchart");
    this.res.end();
  } 
    ...
    postMessage("http://daddyleagues.com/r3dzone/team/"+request.text.substring(5,8)+"/schedule");
    this.res.end();
  }
    ...
    var rep = req.replace(/ /,"+");
    postMessage("http://daddyleagues.com/r3dzone/players?name="+rep+"&position=all&team=all");
