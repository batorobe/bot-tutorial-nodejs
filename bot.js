...
function respond() {
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    this.res.writeHead(200);
    postMessage("http://daddyleagues.com/xrmlII/team/"+request.text.substring(5,8)+"/depthchart");
    this.res.end();
  } 
  else if(request.text && botRegexS.test(request.text)) {
    this.res.writeHead(200);
    postMessage("http://daddyleagues.com/xrmlII/schedules");
    this.res.end();
  } 
    ...
    this.res.writeHead(200);
    postMessage("http://daddyleagues.com/xrmlII/rules");
    this.res.end();
  } 
    ...
    this.res.writeHead(200);
    postMessage("http://daddyleagues.com/xrmlII/team/"+request.text.substring(5,8)+"/schedule");
    this.res.end();
  }
    ...
    var rep = req.replace(/ /,"+");
    postMessage("http://daddyleagues.com/xrmlII/players?name="+rep+"&position=all&team=all");
    this.res.end();
  }  
